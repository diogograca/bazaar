<!--  This is the body view of create a proposal page   -->
<div class="container">
...
<div class="container">
    <div id="create_proposal">
        <form method="POST" action="<?php echo base_url(); ?>index.php/createProposal/create_Proposal"
            ...
            <div>
                ...
                <input class="btn btn-primary" name="submitJS" type="button" value="Submit Proposal"
                       onClick="submit_form();"/>
            </div>
